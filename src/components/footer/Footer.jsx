...
const Footer = () => {
    return (
        ...
        <footer>
           <footer className='mt-5 p-10 bg-black'>
           ...
           <div className='col-md-4'>
            ...
            <div className='col-md-2 pl-8'>
                <h2 className='font-bold text-2xl'>Our Gallery</h2>
                <div className='grid md:grid-cols-2 grid-cols-3 gap-x-0 gap-y-2 mt-14'>
                    <div>
                    <img className='h-16' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoJ4kQ8tPFsS5f7sWJFOngWPAsOizwWmAphg&usqp=CAU" alt="" />
                    </div>
                    <div>
                    <img className='h-16' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoJ4kQ8tPFsS5f7sWJFOngWPAsOizwWmAphg&usqp=CAU" alt="" />
                    </div>
