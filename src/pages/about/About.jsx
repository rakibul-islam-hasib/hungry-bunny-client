...
import picture from '../../../public/aboutPage.jpg';
...
<div className='mt-7 md:flex mb-4'>
  ...
  <div className='w-[50%]'>
    <img style={{height: 400}} className='rounded-lg' src="https://previews.123rf.com/images/yupiramos/yupiramos1506/yupiramos150603691/40932571-food-delivery-design.jpg" alt="" />
  </div>
</div>
    </div>
    );
