...
const Contact = () =>  {
    ...
    return (
        <div className=''>
            ...
            <input type="submit" className=' rounded-3xl text-center bg-orange-600 w-full hover:bg-orange-700 mt-8 text-white font-bold py-2 px-4 rounded-full' value="Send" />
          </form>
            </div>
            <div className='w-[50%]'>
