...
<div className='w-[50%] hover:border-4 border-pink-500  pr-48 pl-48 pt-32 pb-36 bg-pink-100 rounded-lg mr-7'>
...
<div className='w-[50%] hover:border-4 border-orange-500 pr-32 pl-32 pt-32 pb-32 bg-orange-100 rounded-lg mr-7'>
  <h2 className='text-4xl font-bold mb-10'>see your activities</h2>
  <h2 className='text-2xl font-bold mb-3 flex'><span className='mr-3'>icon </span> <span className='mr-3'>orders</span> <span>number</span></h2>
  <h2 className='text-2xl font-bold mb-3 flex'><span className='mr-3'>icon </span> <span className='mr-3'>payments</span> <span>number</span></h2>
  <h2 className='text-2xl font-bold mb-3 flex'><span className='mr-3'>icon </span> <span className='mr-3'>bookings</span> <span>number</span></h2>
  <h2 className='text-2xl font-bold mb-3 flex'><span className='mr-3'>icon </span> <span className='mr-3'>reviews</span> <span>number</span></h2>
