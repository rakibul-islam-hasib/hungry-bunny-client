            ...
            <div className='md:flex lg:flex'>
                <div className='w-[60%]'>
                 ...
                 <div className='w-[40%]'>
                    ...
                    <h2 className='pr-20'>I recently had the pleasure of using FoodEaze, and I must say it's been an absolute game-changer for my dining experience. As a busy professional, I often find myself too tired to cook after a long day. FoodEaze has stepped in to fill that gap, and I'm thoroughly impressed.</h2>
